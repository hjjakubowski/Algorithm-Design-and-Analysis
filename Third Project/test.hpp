...
// Zwraca true, jeœli na danym polu jest figura o danym znaku ('P', 'p', 'R', 'k' itd.)
...
void test_chess_engine() {
    ...
    board.squares[7][0] = NONE; // Upewnij siê, ¿e pole promocji jest puste!
    board.squares[6][0] = makePiece(PAWN, WHITE); // bia³e na a7
    ...
    board.makeMove(5, 2, 4, 3); // c6d5 (bije bia³ego skoczka)
